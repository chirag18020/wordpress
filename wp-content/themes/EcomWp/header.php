                                    ...
                                    <ul>
                                        ...
                                        <li><a href="javascript:void(0)">Language <i class="fa fa-chevron-down"></i></a>
                                            <ul class="ht-dropdown">
                                                <li class="active"><a href="javascript:void(0)"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/menu/icon/1.jpg" alt="JB's Language Icon">English</a></li>
                                                <li><a href="javascript:void(0)"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/menu/icon/2.jpg" alt="JB's Language Icon">Français</a>
                                                </li>
                                            </ul>
                                        </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3 d-block d-lg-none">
                            <div class="header-logo_area header-sticky_logo">
                                <a href="index.html">
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/menu/logo/1.png" alt="Uren's Logo">
                                </a>
                            </div>
                        </div>
                                    ...
                                    <li class="minicart-wrap">
                                        <a href="#miniCart" class="minicart-btn toolbar-btn">
                                            ...
                                            <div class="minicart-front_text">
                                                <span><?php _e('Cart:', 'woothemes'); ?></span>
                                                <span class="total-price"><?php echo get_woocommerce_currency_symbol(); echo WC()->cart->total; ?></span>
                                            </div>
                                        </a>
                                    </li>
                            ...
                            <div class="header-right_area">
                                <ul>
                                    ...
                                    <li class="minicart-wrap">
                                        <a href="#miniCart" class="minicart-btn toolbar-btn">
                                            <div class="minicart-count_area">
                                                <span class="item-count"><?php echo count( WC()->cart->get_cart() ); ?></span>
                                                <i class="ion-bag"></i>
                                            </div>
                                            <div class="minicart-front_text">
                                                <span><?php _e('Cart:', 'woothemes'); ?></span>
                ...
                <div class="offcanvas-menu-inner">
                    ...
                    <div class="minicart-content">
                        <div class="minicart-heading">
                            ...
                            <h4><?php esc_html_e( 'Shopping Cart', 'woocommerce' ); ?></h4>
                        </div>
									...
									<li class="minicart-product">
										<?php
											echo apply_filters(
												...
												sprintf(
													'<a href="%s" class="product-item_remove remove remove_from_cart_button" aria-label="%s" data-product_id="%s" data-cart_item_key="%s" data-product_sku="%s"><i class="ion-android-close" title="Remove"></i></a>',
										...
										<div class="product-item_img">
											<?php													
												$thumbnail = apply_filters( 'woocommerce_cart_item_thumbnail', $_product->get_image('cart-thumb-image'), $cart_item, $cart_item_key );
										...
										<div class="product-item_content">
											<?php
												if ( ! $product_permalink ) {
													...
													echo wp_kses_post( apply_filters( 'woocommerce_cart_item_name', sprintf( '<a class="product-item_title" href="%s">%s</a>', esc_url( $product_permalink ), $_product->get_name() ), $cart_item, $cart_item_key ) );
												}
											...
											<?php echo apply_filters( 'woocommerce_widget_cart_item_quantity', '<span class="product-item_quantity">' . sprintf( '%s &times; %s', $cart_item['quantity'], $product_price ) . '</span>', $cart_item, $cart_item_key ); ?>
										</div>
									</li>
							<?php } } ?>		
                        </ul>
                    ...
                    <div class="minicart-btn_area">
                        <a href="<?php echo $woocommerce->cart->get_cart_url(); ?>" class="uren-btn uren-btn_dark uren-btn_fullwidth"><?php _e('Minicart', 'woothemes'); ?></a>
                    </div>
                    <div class="minicart-btn_area">
                        <a href="<?php echo esc_url( wc_get_checkout_url() ); ?>" class="uren-btn uren-btn_dark uren-btn_fullwidth wc-forward<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>"><?php _e('Checkout', 'woothemes'); ?></a>
                    </div>
                </div>
            </div>
